...
:m1
Echo  #--------------------------------------------#--------------------------------------------# 
Echo  *                COMMANDS                    *                   Русский                  *
Echo  #--------------------------------------------#--------------------------------------------# 
Echo  *  Switch/update - MASTER branch         1   *  Переключить\обновить - ветка MASTER       *
Echo  *  Switch/update - DEV branch            2   *  Переключити\обновить - ветка DEV          *
Echo  #--------------------------------------------#--------------------------------------------# 
echo  *  Reset changes in local repo!          3   * Сбросить изменения в локальном репозитории!*
...
Echo  #--------------------------------------------#--------------------------------------------#
Echo  *         Build and flash (DEBUG)            *       Сборка и прошивка  (ДЕБАГ)           *
...
Echo  *  Serial port monitor                   D   *  Монитор порта                             *
Echo  #--------------------------------------------#--------------------------------------------#
Echo  *  Update FS data from framework         u   *  Обновить файлы ФС из фреймворка           *
Echo  *          FS for ESP8266                    *                для ESP8266                 *
Echo  *  Build File System image               b   *  Собрать файловую систему                  *
Echo  *  Build and upload File System          f   *  Собрать и прошить файловую систему        *
Echo  *            FS for ESP32                    *                для ESP32                   *
Echo  *  Build File System image              b1   *  Собрать файловую систему                  *
Echo  *  Build and upload File System         f1   *  Собрать и прошить файловую систему        *
Echo  #--------------------------------------------#--------------------------------------------#
Echo  *  Erase Flash    ESP8266                e   *  Стереть Флэш    ESP8266                   *
Echo  *  Erase Flash    ESP32                 e1   *  Стереть Флэш    ESP32                     *
Echo  #--------------------------------------------#--------------------------------------------#
Echo  *  Update libs and PIO Core              g   *  Обновить библиотеку и среду PIOCore       *
Echo  *  Clean up temp files .pio              c   *  Отчистить временные файлы .pio            *
Echo  *--------------------------------------------#--------------------------------------------*
Echo  *  CMD window                            m   *  Открыть командную строку                  *
Echo  *--------------------------------------------#--------------------------------------------*
Echo  *  Remove Platformio installation        R   *  Полностью удалить Platformio              *
Echo  #--------------------------------------------#--------------------------------------------#
Echo.
