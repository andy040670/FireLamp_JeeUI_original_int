...
:m1
Echo  #------------------------------------------#-----------------------------------------# 
Echo  *                COMMANDS                  *      (Русский) КОММАНДЫ                 *
Echo  #------------------------------------------#-----------------------------------------# 
...
Echo  #------------------------------------------#-----------------------------------------# 
echo  *  Reset changes in local repo!     - (3)  *  Сброс изменений в локальном репо!      *
Echo  *  WARNING! This will revert all changes!  *  ВНИМАНИЕ! Это отменит все изменения!   *
Echo  #------------------------------------------#-----------------------------------------# 
Echo  *                Build only                *              Только сборка              *
Echo  *  Build - Esp8266 160MHz           - (4)  *  Собрать для Esp8266 на 160MHz          *
Echo  *  Build - Esp8266 80MHz            - (5)  *  Собрать для Esp8266 на 80MHz           *
Echo  *  Build - Esp32                    - (6)  *  Собрать для Esp32                      *
Echo  #------------------------------------------#-----------------------------------------#
Echo  *             Build and flash              *            Сборка и прошивка            *
Echo  *  Build and upload - Esp8266@160   - (7)  *  Собрать и прошить - Esp8266 на 160MHz  *
Echo  *  Build and upload - Esp8266@80    - (8)  *  Собрать и прошить - Esp8266 на 80MHz   *
Echo  *  Build and upload - Esp32         - (9)  *  Собрать и прошить - Esp32              *
Echo  #------------------------------------------#-----------------------------------------#
Echo  *         Build and flash (DEBUG)          *      Сборка и прошивка (DEBUG)          *
Echo  *  Build and upload - Esp8266@160   - (7D) *  Собрать и прошить - Esp8266 на 160MHz  *
Echo  *  Build and upload - Esp8266@80    - (8D) *  Собрать и прошить - Esp8266 на 80MHz   *
Echo  *  Serial port monitor               - (D) *  Вывод отладочной информации            *
Echo  #------------------------------------------#-----------------------------------------#
Echo  *  Update FS data from framework    - (u)  *  Обновление данных ФС из фреймворка     *
Echo  *          FS for ESP8266                  *              FS для ESP8266             *
Echo  *  Build File System image          - (b)  *  Собрать образ Файловый Системы         *
Echo  *  Build and upload File System     - (f)  *  Собрать и прошить Файловую Систему     *
Echo  *            FS for ESP32                  *                FS для ESP32             *
Echo  *  Build File System image         - (b1)  *  Собрать образ Файловый Системы         *
...
Echo  *  Clean up temp files .pio         - (c)  *  Очистка временных файлов .pio          *
Echo  *------------------------------------------#-----------------------------------------*
Echo  *  CMD window                       - (m)  *  Открыть оконо коммандной строки CMD    *
Echo  *------------------------------------------#-----------------------------------------*
